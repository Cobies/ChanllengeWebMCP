    ...
    <header class="border-b border-slate-800 bg-slate-950/80 backdrop-blur-md sticky top-0 z-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
          <div class="w-10 h-10 rounded-xl bg-gradient-to-tr from-cyan-500 via-blue-600 to-indigo-600 p-[1px] shadow-lg shadow-cyan-500/20 shrink-0">
          ...
          <div>
            <div class="flex items-center gap-2">
              <h1 class="text-base sm:text-lg font-bold bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent">
        ...
        <!-- Navigation Tabs -->
        <nav class="flex items-center gap-1.5 p-1 bg-slate-900/90 border border-slate-800/80 rounded-xl text-xs font-medium">
          <a
            routerLink="/3d-showroom"
            routerLinkActive="bg-cyan-500/20 text-cyan-300 border-cyan-500/40 shadow-sm shadow-cyan-500/20 font-semibold"
            [routerLinkActiveOptions]="{ exact: false }"
            class="px-3 py-1.5 rounded-lg border border-transparent text-slate-400 hover:text-slate-200 hover:bg-slate-800/60 transition-all flex items-center gap-1.5">
            <span>🏎️</span>
        ...
        <div class="flex flex-wrap items-center gap-2">
          <!-- Runtime Mode Badge -->
          <div class="flex items-center gap-2 px-2.5 py-1.5 rounded-lg bg-slate-900/90 border border-slate-800 text-xs">
          ...
          <div class="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-slate-900/90 border border-slate-800 text-xs text-slate-300">
          ...
          <button
            (click)="openCopilot()"
            class="px-3 py-1.5 rounded-lg bg-gradient-to-r from-cyan-500/20 to-purple-600/20 hover:from-cyan-500/30 hover:to-purple-600/30 border border-cyan-500/50 hover:border-cyan-400 text-xs font-semibold text-cyan-300 shadow-md shadow-cyan-500/20 transition-all flex items-center gap-1.5">
            <span class="relative flex h-2 w-2">
      ...
      <div class="border-t border-slate-800/60 bg-slate-950/50 px-4 sm:px-6 lg:px-8 py-2 overflow-x-auto flex items-center gap-2">
        ...
        @if (isEnterpriseRoute()) {
          ...
          <button
            ...
            class="px-2.5 py-1 text-xs rounded-md bg-slate-900 hover:bg-emerald-950/40 hover:text-emerald-300 hover:border-emerald-500/40 border border-slate-800 text-slate-300 transition-all whitespace-nowrap flex items-center gap-1">
