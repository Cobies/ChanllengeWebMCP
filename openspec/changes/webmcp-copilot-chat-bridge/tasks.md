...
- [ ] 2.2 Implement model discovery and fallback recovery in `projects/showcase/src/app/services/copilot-bridge.service.ts` querying `GET https://bridge.cobiesscooby.com/v1/models`.
